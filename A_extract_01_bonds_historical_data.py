...
def extract_bonds_historical_data(save_csv = True):
    import investpy
    import pandas as pd
    import numpy as np
    import re
    ...
    today = date.today()
    some_days_ago = today - timedelta(days=20)
    some_days_ago_str = some_days_ago.strftime("%d/%m/%Y")
    ...
    final_df['Interest'] = final_df['Interest']/100
    if save_csv:
